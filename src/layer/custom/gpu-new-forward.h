...
public:
    ...
    void conv_forward_gpu_prolog(const float *host_y, float *host_x, float *host_k, float *device_y_ptr, float *device_x_ptr, float *device_k_ptr, const int B, const int M, const int C, const int H, const int W, const int K);
